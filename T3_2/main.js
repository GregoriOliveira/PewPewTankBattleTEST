  ...
  // Uso
    if (isMobile()) {
        ...
        const joystick = nipplejs.create({
          ...
          mode: 'static',
          position: { left: '50px', bottom: '50px' },  // Posição do joystick
          color: 'blue',
          size: 150
        });
        ...
        joystick.on('move', function (evt, data) {
          if (data.direction) {
            ...
            switch (angle) {
              case 'up':
                keyboard.pressed("W"); // Simula pressionar a tecla W
                break;
              case 'down':
                keyboard.pressed("S"); // Simula pressionar a tecla S
                break;
              case 'left':
                keyboard.pressed("A"); // Simula pressionar a tecla A
                break;
              case 'right':
                keyboard.pressed("D"); // Simula pressionar a tecla D
                break;
            }
          }
        });
