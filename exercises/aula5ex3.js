...
var cyl2 = new THREE.Mesh(cylinderGeometry2, cylinderMaterial3);
var cyl3 = new THREE.Mesh(cylinderGeometry2, cylinderMaterial3);
...
function rotateCylinder() {
  ...
  cyl2.matrixAutoUpdate = false;
  cyl3.matrixAutoUpdate = false;
  ...
  if (animationOn) {
    ...
    cyl2.matrix.identity();
    cyl3.matrix.identity();
    ...
    cyl2.matrix.multiply(mat4.makeRotationY(angle));
    cyl2.matrix.multiply(mat4.makeTranslation(0, -0.5, 0));
    cyl2.matrix.multiply(mat4.makeRotationX(THREE.MathUtils.degToRad(90)));

    cyl3.matrix.multiply(mat4.makeRotationY(-angle));
    cyl3.matrix.multiply(mat4.makeTranslation(0, 0.5, 0));
    cyl3.matrix.multiply(mat4.makeRotationX(THREE.MathUtils.degToRad(90)));
