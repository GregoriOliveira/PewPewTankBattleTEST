...
// Create ramp
let points = [
  new THREE.Vector3(-1, 0, -1), // Inferior esquerdo
  new THREE.Vector3(1, 0, -1),  // Inferior direito
  new THREE.Vector3(1, 0, 1),   // Superior direito
  new THREE.Vector3(-1, 0, 1),  // Superior esquerdo
  new THREE.Vector3(-1, 1, 1),  // Superior esquerdo elevado
  new THREE.Vector3(1, 1, 1)    // Superior direito elevado
];
let rampGeometry = new ConvexGeometry(points);
let rampMaterial = new THREE.MeshLambertMaterial({ color: 0x00ff00 });
